...
mathjax: true
comments: R / R Studio 환경세팅 작업 하기
---
...
|1|[Basic Source](#basic-source)|기초명령어|
...
|-:|:--:|:--:|:--:|:--:|:-|
|1|통계패키지 R기본학습|에이콘 아카데미|[조효은](https://cafe.naver.com/honeyjava)|Jun 8~30 2018|`R`|
...
|-:|:-:|:-:|:-:|:--|
|0|통계패키지 R기본학습|에이콘 아카데미|[stringr.ipynb](https://github.com/shpimit/shpimit.github.io/tree/master/_pages/Language/R/src/stringr.ipynb)|문자열 패키지(stringr)|
|1|통계패키지 R기본학습|에이콘 아카데미|[dataframe.ipynb](https://github.com/shpimit/shpimit.github.io/tree/master/_pages/Language/R/src/dataframe.ipynb)|데이타프레임(dplyr)|
|2|통계패키지 R기본학습|에이콘 아카데미|[excel_data.ipynb](https://github.com/shpimit/shpimit.github.io/tree/master/_pages/Language/R/src/excel_data.ipynb)|외부파일 읽기(readxl)|
|3|통계패키지 R기본학습|에이콘 아카데미|[mpg.ipynb](https://github.com/shpimit/shpimit.github.io/tree/master/_pages/Language/R/src/mpg.ipynb)|연비데이터(ggplot2)|
|4|통계패키지 R기본학습|에이콘 아카데미|[midwest.ipynb](https://github.com/shpimit/shpimit.github.io/tree/master/_pages/Language/R/src/midwest.ipynb)|중서부인구 통계 데이터(ggplot2)|
