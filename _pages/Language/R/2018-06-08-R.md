...
|-:|:-:|:-:|:-:|:--|
|0|<small>통계패키지 R기본학습</small>|<small>에이콘 아카데미</small>|[stringr.ipynb]({{ site.baseurl }}{% link _pages/Language/R/src/stringr.ipynb %})|문자열 패키지(stringr)|
|1|<small>통계패키지 R기본학습</small>|<small>에이콘 아카데미</small>|[dataframe.ipynb](https://github.com/shpimit/shpimit.github.io/tree/master/_pages/Language/R/src/dataframe.ipynb)|데이타프레임(dplyr)|
